...
if st.session_state.information_button_clicked == True:
    ...
    c.write("**09:00 - 09:15:** Opening - Welcome Speech")
    c.write("**09:15 - 10:30:** Student Presentations: Keyu MAO, Alex WASCHTSHC, Alice RAVEZ, Fakhri-Eddin LAHFAIDH, Anastasiia PIDVOROTNIA")
    c.write("**10:30 - 11:00:** Small Coffee Break")
    c.write("**11:00 - 11:30:** Invited Speaker: Dr. Hervé RAPS")
    c.write("**11:30 - 12:15:** Student Presentations: Matthieu JORANDON, Sandra LITWIN, Jean-Baptiste COFFIN")
